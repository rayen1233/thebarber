/**
 * API admin catalogue — source de vérité unique (Vercel Blob).
 * GET    — lire le catalogue
 * DELETE ?id= — supprimer un produit
 * POST   — { product } upsert un produit
 * PUT    — { products, users?, orders? } remplacer tout le catalogue
 */
